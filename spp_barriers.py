...
Shortest path between two points with barriers
...
def hspp_b(barriers, sources, targets, wL = 0, A4 = True, log=False, picture=False, time_limit=7200, init=False):
    ...
    return time_h, objval_h, x_indices
